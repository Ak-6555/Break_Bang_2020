...
public class Gameplay4 extends JPanel implements KeyListener, ActionListener {
	...
	private int ballydir = -1;//direction of the first ball along y-axis
	private MapGenerator4 mapob;//generator the outlining of bricks
	
	private int totalbrick = 44;//number of total bricks
	private Font f, f2;//declares variable under font class
        
        
        
	// second ball
	private int secondBallPosX = 340;//position of the second ball along x-axis
	private int secondBallPosY = 365;//position of the second ball along y-axis
	...
	private int secondBallDirY = +2;//direction of the first ball along y-axis
        ...
        private int bonusDY=-100;//position of the bonusD brick along y-axis
        ...
        private int cnt4=0;//counter when bonusD brick hits paddle 
        private int cnt5=0;//counter when heart sign hits paddle 
        
        //score
        public static int score = Gameplay3.score;//a variable declared to keep track of the score,which is initially Level3's score
        
        //life
        private int lifeposY=-200;//position of heart sign along y-axis
        public static int life=Gameplay3.life;  //a variable declared to keep track of the score,which is initially Level3's life 
	...
	public void paint(Graphics g) {
		...
		g.drawString("Life : "+life, 915, 20);       
                ...
                //D
                g.setColor(new Color(219, 9, 72));
                g.fill3DRect(900,bonusDY, 70, 30,true);
                g.setColor( Color.WHITE);
                f = new Font("Arial", Font.PLAIN, 18);
                g.setFont(f);
                g.drawString("1000+", 910,bonusDY+20);
		...
		if (play) {
			if (new Rectangle(ballposX, ballposY, 20, 20).intersects(new Rectangle(playerX, 340, playerWidth, 10))) {
				ballydir = (ballydir * -1);
						...
						.intersects(new Rectangle(playerX, 340, playerWidth, 10))) {
				...
				if (secondBallPosY> 655) {
					secondBallDirY = (secondBallDirY * -1);
                                ...
                                if(totalbrick<=35)
                                {
                                    ...
                                    if(cnt4==0)
                                    {
                                    if (new Rectangle(900, bonusDY, 70, 30 ).intersects(new Rectangle(playerX, 637, playerWidth, 20))) {
                                     score=score+1000;
                                     cnt4++;
                                    }
                                    }
