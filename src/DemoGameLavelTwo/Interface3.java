...
public class Interface3 extends JFrame implements ActionListener {
    ...
    private ImageIcon icon,iconplay,iconexit,iconmm,iconhelp,iconbackground;//declares variables under ImageIcon class
    private JLabel imglabel;//declares variables under JLabel class
    private JButton btncontinue,btnhelp,btnexit,btnmain,btnlife,btnscore;//declares variables under JButton class
            ...
            
    {
     ...
     { 
         ...
         c.setLayout(null);
          ...
          btnscore = new JButton("Your Score : "+Gameplay2.score);
          ...
          btnlife = new JButton("life : "+ Gameplay2.life);
          ...
          iconbackground=new ImageIcon("src/BACK3.jpg");
    ...
    public static void main(String[] args) {
        ...
        /**
    	 * creates an object of Interface3 class
    	 */
        
        Interface3 menu=new Interface3();
