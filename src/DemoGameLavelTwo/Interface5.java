...
public class Interface5 extends JFrame implements ActionListener {
    ...
    private ImageIcon iconbackground,iconplay,iconhelp,iconmm,iconexit,icon;//declares variables under ImageIcon class
    ...
    Interface5()
     ...
     { 
         ...
         c.setLayout(null);
          ...
          btnscore = new JButton("Your Score : "+Gameplay4.score);
          ...
          btnlife = new JButton("life : "+ Gameplay4.life);
          ...
          iconbackground=new ImageIcon("src/BACK5.jpg");
      ...
      public static void main(String[] args) {
        ...
        /**
    	 * creates an object of Interface5 class
    	 */
        
        Interface5 menu=new Interface5();
